...
"dotnet.exe" publish "TcpTunnel\TcpTunnel.csproj" -f net6.0 -c Release -r win-x64 -p:Platform=AnyCPU --self-contained -p:PublishTrimmed=true -p:PublishSingleFile=true
if not errorlevel 1 (
	echo.
